...
<title>⬢ mayday clip — ${esc(meta.data.name || 'session')}</title>
<style>
...
<div class="wrap">
  ...
  <div class="foot">generated by mayday — the flight recorder for AI agents · this file is self-contained; share it anywhere</div>
</div>
<script>
